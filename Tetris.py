...
ESTE CÓDIGO ESTA SENDO ADAPTADO EM Environment.py PARA ADEQUÁ-LO PARA TREINAMENTO DE UMA IA, ESTE AQUI ESTÁ DESATUALIZADO E NÃO SERÁ MAIS MODIFICADO. ESSE CÓDIGO FOI CRIADO INICIALMENTE PARA DESENVOLVER A LÓGICA DO JOGO.
PARA UM USUÁRIO CONSEGUIR JOGÁ-LO É NESCESSÁRIO QUE AS DUAS ÚLTIMAS LINHAS SEJAM EDITADAS PARA DEIXAREM DE SEREM COMENTÁRIOS.
